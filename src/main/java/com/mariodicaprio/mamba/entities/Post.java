...
public class Post {
     ...
     */
    @ManyToMany(fetch = FetchType.EAGER, cascade = CascadeType.PERSIST, mappedBy = "likes")
    private List<User> likes = new ArrayList<>();

    //////////////////////////////////////////////////////////////

    /**
     * The post that is reposted by this post (e.g. if this post is a comment to another post).
     */
    @JoinColumn(name = "repostId")
    @ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.PERSIST)
    private Post reposts;

    //////////////////////////////////////////////////////////////

    /**
     * The posts that repost this post (e.g. comments to this post).
     */
    @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.PERSIST, mappedBy = "reposts")
    private List<Post> repostedBy = new ArrayList<>();
    ...
    public enum PostType {
        /**
         * The post is completely textual. No image and no video are
         * included.
         */
        TEXT,
        /**
         * The post is intended to be a picture. Textual data is optional.
         * The format of the contained media is {@code .png}.
         */
        PICTURE,
        /**
         * The post is intended to be a video. Textual data is optional.
         * The format of the contained media is {@code .mp4}.
         */
        VIDEO,
        /**
